      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        <div className="space-y-6">
          <div className="space-y-1.5">
            <Label htmlFor="email" className="text-[9px] font-black text-muted-foreground uppercase tracking-widest ml-0.5">
                Account ID
            </Label>
            <div className="relative group">
                <Mail className="absolute left-0 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-muted-foreground/50 group-focus-within:text-primary transition-all duration-300" />
                <Input
                  id="email"
                  type="email"
                  ...
                  {...register('email')}
                  className={cn(
                      "bg-transparent border-0 border-b-2 border-slate-200 dark:border-zinc-800 h-12 pl-7 rounded-none font-bold transition-all focus:border-primary focus:ring-0 text-base placeholder:text-muted-foreground/20",
          ...
          <div className="space-y-1.5">
             <Label htmlFor="password" id="pass-label" className="text-[9px] font-black text-muted-foreground uppercase tracking-widest ml-0.5">
                Access Key
            </Label>
            <div className="relative group">
            ...
            {errors.password && <p className="text-[9px] text-destructive font-bold uppercase tracking-tighter ml-0.5">Password required</p>}
          </div>
        </div>
