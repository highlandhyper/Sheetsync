    ...
    const startImport = async () => {
        ...
        Papa.parse(file, {
            ...
            complete: async (results) => {
                ...
                setIsImporting(false);
                toast({ title: "Import Complete", description: `Processed ${data.length} records successfully.` });
                refreshData();
            }
        });
    };
                    ...
                    {currentStep === 'upload' && (
                        <div className="flex flex-col items-center justify-center py-10 space-y-6 text-center">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-xs text-muted-foreground max-w-xs font-medium">Upload your local database (CSV) to begin the industrial synchronization process.</p>
                            </div>
                            <input 
                                type="file" 
                                ref={fileInputRef} 
                    ...
                    {currentStep === 'map' && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <div className="flex items-center gap-3 p-4 bg-primary/5 rounded-2xl border border-primary/10">
                                ...
                                <h4 className="text-sm font-black uppercase tracking-widest">Schema Mapping</h4>
                            </div>

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-3">
                                    <Label className="text-[10px] font-black uppercase text-muted-foreground tracking-widest ml-1">Barcode (Required)</Label>
                                ...
                                <div className="space-y-3">
                                    <Label className="text-[10px] font-black uppercase text-muted-foreground tracking-widest ml-1">Product Name (Required)</Label>
                                ...
                                <div className="space-y-3">
                                    <Label className="text-[10px] font-black uppercase text-muted-foreground tracking-widest ml-1">Supplier (Required)</Label>
                                ...
                                <div className="space-y-3">
                                    <Label className="text-[10px] font-black uppercase text-muted-foreground tracking-widest ml-1">Cost Price (Optional)</Label>
