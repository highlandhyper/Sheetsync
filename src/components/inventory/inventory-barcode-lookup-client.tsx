...
export function InventoryBarcodeLookupClient() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <CardContent className="p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row items-stretch gap-3">
            ...
            <div className="flex gap-2 h-14">
                <Button onClick={() => setIsScannerDialogOpen(true)} variant="outline" className="flex-1 sm:flex-none px-6 h-full rounded-2xl border-white/5 font-black uppercase tracking-widest text-[10px]"><Scan className="mr-2 h-5 w-5 text-primary" /> Scan</Button>
      ...
      <Dialog open={isScannerDialogOpen} onOpenChange={setIsScannerDialogOpen}><DialogContent className="max-w-md w-[95%] p-0 overflow-hidden rounded-3xl border-none shadow-2xl bg-black"><DialogHeader className="p-8 pb-4 bg-zinc-900/50 absolute top-0 left-0 right-0 z-20"><DialogTitle className="text-2xl font-black tracking-tighter flex items-center gap-3 uppercase text-primary"><Scan className="h-8 w-8" /> Visual Capture</DialogTitle><DialogDescription className="text-xs font-medium text-zinc-400">Position barcode within the frame.</DialogDescription></DialogHeader><div className="relative scanner-container h-[400px] w-full"><div id={SCANNER_REGION_ID} className="h-full w-full bg-black relative [&>span]:hidden" /><div className="scanner-overlay"><div className="scanner-focus"><div className="scanner-laser" /><div className="scanner-corner scanner-corner-tl" /><div className="scanner-corner scanner-corner-tr" /><div className="scanner-corner scanner-corner-bl" /><div className="scanner-corner scanner-corner-br" /></div></div></div><div className="p-6 bg-zinc-900/50 border-t border-white/10 relative z-20"><Button variant="outline" onClick={() => setIsScannerDialogOpen(false)} className="w-full h-14 rounded-2xl font-black uppercase tracking-widest text-destructive border-white/5 transition-all">Abort Scan</Button></div></DialogContent></Dialog>
